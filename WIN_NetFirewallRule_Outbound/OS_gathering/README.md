Ansible Role: OS-Windows2016/WIN_NetFirewallRule_Outbound/OS_gathering
=======================================================
# Description
...
| `- Name:` | 「送信の規則」の「名前」に該当 | 
| &nbsp;&nbsp;&nbsp;&nbsp;`DisplayName` | 「送信の規則」の「名前」に該当 | 
| &nbsp;&nbsp;&nbsp;&nbsp;`RuleDescription` | 各ファイアウォール規則のプロパティの「全般」の「説明」に該当 | 
| &nbsp;&nbsp;&nbsp;&nbsp;`Group` | DisplayGroupのOS内情報 | 
| &nbsp;&nbsp;&nbsp;&nbsp;`DisplayGroup` | 「送信の規則」の「グループ」に該当 | 
| &nbsp;&nbsp;&nbsp;&nbsp;`Enabled` | 「送信の規則」の「有効」に該当 | 
| &nbsp;&nbsp;&nbsp;&nbsp;`FirewallAction` | 「送信の規則」の「操作」に該当 | 
| &nbsp;&nbsp;&nbsp;&nbsp;`Profile` | 「送信の規則」の「プロファイル」に該当 | 
| &nbsp;&nbsp;&nbsp;&nbsp;`LocalAddress` | 「送信の規則」の「ローカルアドレス」に該当 | 
| &nbsp;&nbsp;&nbsp;&nbsp;`LocalPort` | ローカルポート | 
| &nbsp;&nbsp;&nbsp;&nbsp;`LocalUser` | ローカルユーザ | 
| &nbsp;&nbsp;&nbsp;&nbsp;`Program` | 「送信の規則」の「プログラム」に該当 | 
| &nbsp;&nbsp;&nbsp;&nbsp;`Protocol` | プロトコル | 
