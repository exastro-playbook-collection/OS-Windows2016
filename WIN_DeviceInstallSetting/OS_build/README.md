Ansible Role: OS-Windows2016/WIN_DeviceInstallSetting/OS_build
=======================================================
# Description
本ロールは、Windows Server 2016に関するデバイスインストール設定についての情報の設定を行います。
...
OS-Windows2016/WIN_DeviceInstallSetting/OS_gatheringロールを利用します。
...
- hosts: all
  gather_facts: true
  roles:
    - role: OS-Windows2016/WIN_DeviceInstallSetting/OS_build
      VAR_WIN_DeviceInstallSetting:
        PreventDeviceMetadataFromNetwork: 0
  strategy: free
~~~
...
- hosts: all
  gather_facts: true
  roles:
    - role: OS-Windows2016/WIN_DeviceInstallSetting/OS_gathering
  strategy: free
~~~
